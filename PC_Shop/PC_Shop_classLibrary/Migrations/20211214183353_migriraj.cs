...
{
    public partial class migriraj : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Korisnik_Ime = table.Column<string>(nullable: true),
                    Korisnik_Prezime = table.Column<string>(nullable: true),
                    Korisnik_Spol = table.Column<string>(nullable: true),
                    Korisnik_DatumRodjenja = table.Column<DateTime>(nullable: true),
                    Korisnik_DrzavaID = table.Column<int>(nullable: true),
                    Pretplacen = table.Column<bool>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_KorisnickiNalog", x => x.ID);
                    table.ForeignKey(
                        name: "FK_KorisnickiNalog_Drzava_DrzavaID",
                        column: x => x.DrzavaID,
                        principalTable: "Drzava",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KorisnickiNalog_Drzava_Korisnik_DrzavaID",
                        column: x => x.Korisnik_DrzavaID,
                        principalTable: "Drzava",
                        principalColumn: "ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Narudzba_KorisnickiNalog_NaruciocID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Oglas_KorisnickiNalog_AutorOglasaID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Post_KorisnickiNalog_KorisnikID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Racun_KorisnickiNalog_KorisnikID",
                        column: x => x.KorisnikID,
                        principalTable: "KorisnickiNalog",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KorisnikOglas_KorisnickiNalog_KorisnikID",
                        column: x => x.KorisnikID,
                        principalTable: "KorisnickiNalog",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KorisnickiNalog_DrzavaID",
                table: "KorisnickiNalog",
                column: "DrzavaID");

            migrationBuilder.CreateIndex(
                name: "IX_KorisnickiNalog_Korisnik_DrzavaID",
                table: "KorisnickiNalog",
                column: "Korisnik_DrzavaID");
